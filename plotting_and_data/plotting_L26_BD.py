...
#plt.savefig("zzy_BD_L26_W3000_ph.svg")
plt.show()
...
#plt.savefig("zzy_BD_L26_W3000_parBD.svg")
plt.show()
...
#plt.savefig("zzy_BD_L26_W3000_lap.svg")
plt.show()
...
#plt.savefig("zzy_BD_L26_W3000_time1.svg")
plt.show()
...
plt.xlabel("Bond Dimension")
plt.ylabel("Run Time (min)")
#plt.savefig("zzy_BD_L26_W3000_time2.svg")
plt.show()
