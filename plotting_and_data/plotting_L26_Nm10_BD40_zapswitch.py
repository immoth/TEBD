...
fileparm="_L26_Nm10_BD40_zapswitch"
...
EendPLL=np.loadtxt("zzz_L26_Nm10_zapswitchEendP")
EendMLL=np.loadtxt("zzz_L26_Nm10_zapswitchEendM")


phALL=np.loadtxt("zzz_phA_L26_d10_Nm10")
phBLL=np.loadtxt("zzz_phB_L26_d10_Nm10")
lapALL=np.loadtxt("zzz_lapA_L26_d10_Nm10")
lapBLL=np.loadtxt("zzz_lapB_L26_d10_Nm10")
parPLL=np.loadtxt("zzz_parA_L26_d10_Nm10")
parMLL=np.loadtxt("zzz_parB_L26_d10_Nm10")
wlistLL=np.loadtxt("zzz_wlist_d26_Nm10")
...
plt.scatter(wlistLL,phALL,s=50)
...
plt.scatter(wlistLL,parPLL,s=50)
plt.xlabel("Ramp Time")
...
plt.scatter(wlistLL,lapALL,s=50)
plt.xlabel("Ramp Time")
...
plt.scatter(wlistL,EendPLL-EendMLL,s=50)
plt.xlabel("Ramp Time")
plt.ylabel("Energy")
