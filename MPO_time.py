...
"Matrix Operators"
def VPOl(U):
    return np.array([I2,(tua+Delta)/2*sx,(tua-Delta)/2*sy,U*sz,-mu*sz])
def MPO(U):
    return np.array([[I2,(tua+Delta)/2*sx,(tua-Delta)/2*sy,U*sz,-mu*sz],[Z2,Z2,Z2,Z2,sx],[Z2,Z2,Z2,Z2,sy],[Z2,Z2,Z2,Z2,sz],[Z2,Z2,Z2,Z2,I2]])
def VPOr(U):
