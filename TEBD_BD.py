...
import MPO
import copy
import U_MPO_cutFunction as U_MPO
import Zap
...
for BD in range(4,30,2):
    ...
    for nt in range(0,Nt):
        ypt=U_MPO.Apply_Uleft(ypt,eF(nt*dt),dt,1,BD)
        ypt=U_MPO.Apply_Uright(ypt,eF(nt*dt),dt,1,BD)
        
        ymt=U_MPO.Apply_Uleft(ymt,eF(nt*dt),dt,1,BD)
        ymt=U_MPO.Apply_Uright(ymt,eF(nt*dt),dt,1,BD)
    ...
    for nt in range(0,Nw):
        ypt=U_MPO.Apply_Uleft(ypt,eF((Nt-1)*dt),dt,1,BD)
        ypt=U_MPO.Apply_Uright(ypt,eF((Nt-1)*dt),dt,1,BD)
        
        ymt=U_MPO.Apply_Uleft(ymt,eF((Nt-1)*dt),dt,1,BD)
        ymt=U_MPO.Apply_Uright(ymt,eF((Nt-1)*dt),dt,1,BD)
    ...
    for nt in range(1,Nt+1):
        ypt=U_MPO.Apply_Uleft(ypt,eF((Nt-nt)*dt),dt,-1,BD)
        ypt=U_MPO.Apply_Uright(ypt,eF((Nt-nt)*dt),dt,-1,BD)
        
        ymt=U_MPO.Apply_Uleft(ymt,eF((Nt-nt)*dt),dt,-1,BD)
        ymt=U_MPO.Apply_Uright(ymt,eF((Nt-nt)*dt),dt,-1,BD)
